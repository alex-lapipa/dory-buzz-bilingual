...
export class RealtimeVoiceChat {
  ...
  async connect() {
    try {
      ...
      this.ws = new WebSocket("wss://zrdywdregcrykmbiytvl.supabase.co/functions/v1/realtime_session");
      ...
      this.ws.onmessage = async (event) => {
        try {
          ...
          // Forward all events to the interface
      ...
      this.ws.onerror = (error) => {
        ...
        this.onMessageCallback({ type: 'error', message: 'Connection error' });
      };
