...
const BuzzyBees: React.FC = () => {
  ...
  return (
    <>
      <PageSEO
        title="Buzzy Bees - Sing Along with Mochi! | MochiBee"
        description="Fun sing-along songs for kids 3-6 about bees, gardens, and nature. Bilingual English & Spanish music with Mochi the Bee!"
      />
